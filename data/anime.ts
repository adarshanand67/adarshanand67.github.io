...
export const animeData = [
    {
        ...
        description: "A repetitive sociological experiment where a pre-teen attempts to catalog every existing creature by capturing them in spherical containment units.",
    ...
    },
    {
        ...
        rating: "8.3/10",
        keyLearnings: [
            "Believe it! Never give up on your path, even if the whole village doubts you.",
            "Bonds are formed through shared pain and the courage to protect each other."
        ]
    },
    {
        title: "Dragon Ball Z",
        ...
        rating: "8.2/10",
        keyLearnings: [
            "Power is meaningless without the will to protect those who cannot protect themselves.",
            "It's over 9000! Limits are just illusions meant to be broken by screaming louder."
        ]
    },
    {
        title: "Bleach",
        ...
        rating: "7.9/10",
        keyLearnings: [
            "If you mirror a sword with a heart, you become the blade itself.",
            "Bankai! True strength is hidden in the depths of your own soul."
        ]
    },
    {
        title: "Death Note",
        ...
        description: "A brilliant student discovers a supernatural ledger and attempts to solve global crime through a series of tactical name-entry sessions.",
        tags: ["Action", "Comedy"],
        year: "2015",
        rating: "8.7/10",
        keyLearnings: [
    ...
    },
    {
        ...
        recommended: true,
        description: "A group of teenagers obsessed with the gravitational manipulation of a spherical object, proving that screaming 'FLY' can actually lead to peak athletic performance.",
    ...
    },
    {
        ...
        recommended: true,
        description: "Expatriate royalty utilizes ocular-based mind control to dismantle a global superpower, all while maintaining impeccable posture and dramatic flair.",
    ...
    },
    {
        ...
        description: "Jazz-infused nihilism in space. A crew of bounty hunters navigates their collective existential dread between sessions of rhythmic physical combat.",
        tags: ["Sci-Fi"],
        year: "1998",
        rating: "8.9/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A self-proclaimed mad scientist upgrades a microwave to facilitate chronological displacement, leading to a profound understanding of causality and bananas.",
    ...
    },
    {
        ...
        description: "A boy with the power to reconstruct reality struggles to find meaning in the mundane, discovering that social calibration is far harder than psychokinesis.",
    ...
    },
    {
        ...
        description: "Metaphysical manifestations of human negativity are mitigated through tactical occult procedures and high-speed anatomical reorganization.",
    ...
    },
    {
        ...
        description: "A ruthless athletic Darwinian experiment designed to cultivate the absolute personification of egoism on the pitch.",
    ...
    },
    {
        ...
        recommended: true,
        description: "The lowest quintile hunter undergoes a forced systematic optimization process, transcending his biological limitations through exponential XP accumulation.",
