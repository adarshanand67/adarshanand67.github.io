...
export const planningAnime = [
    ...
    { title: "Chihayafuru", type: AnimeType.Anime, status: WatchStatus.Planning, seasons: "S1-3", image: "", description: "", tags: [], keyLearnings: [] },
    {
        ...
        description: "A high-stakes sports anime disguised as a card game based on classical poetry, making Karuta look more intense than professional MMA.",
        tags: ["Drama", "Sports"],
        year: "2011",
        rating: "8.2/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A peaceful, episodic journey about a boy returning names to spirits his grandmother defeated, proving that non-violence is the ultimate flex.",
    ...
    },
    {
        ...
        seasons: "S1-3",
        image: "https://cdn.myanimelist.net/images/anime/10/82594l.webp",
        description: "A visually avant-garde exploration of urban legends and psychological hang-ups, delivered via rapid-fire dialogue and neck-snapping head tilts.",
    ...
    },
    {
        ...
        description: "A contemplative masterpiece about a wanderer researching primeval life forms that exist in the peripheral vision of human experience.",
