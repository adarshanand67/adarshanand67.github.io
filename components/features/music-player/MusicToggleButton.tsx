...
export function MusicToggleButton() {
    ...
    return (
        <button
            ...
            className="fixed bottom-8 right-8 z-[101] w-14 h-14 bg-foreground text-background rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.3)] hover:scale-110 active:scale-90 transition-all duration-300 group"
