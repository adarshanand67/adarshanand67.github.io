...
function getTechIcon(name: string) {
  const icons: Record<string, any> = {
    ...
    TypeScript: Code,
    Bash: TerminalIcon,
    "Intel SGX/TDX": Activity,
    Gramine: FileJson,
    "System Programming": Laptop,
    "Windows Internals": Laptop,
    Ubuntu: Globe,
    CentOS: Globe,
    RHEL: Globe,
    "Data Loss Prevention": Check,
    "Trellix ePO": Activity,
    ...
    "Address Sanitizer": Activity,
    "Memory Sanitizer": Activity,
      ...
      <AnimatePresence>
        {isExpanded && (
          <motion.div
            ...
            className="overflow-hidden"
          >
            <p className="opacity-60 mb-8 max-w-2xl text-sm font-medium">
              I'm always open to discussing new opportunities, interesting
              projects, collaborations, or just chatting about tech, security,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link
                href={`https://${siteConfig.contact.linkedin}`}
                target="_blank"
                className="p-4 rounded-2xl glass border border-white/10 hover:shadow-lg transition-all group"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold">
                      {siteConfig.contact.linkedin.split("/").pop()}
                    </div>
                  </div>
                </div>
              </Link>
              <div
                ...
                className="p-4 rounded-2xl glass border border-white/10 hover:shadow-lg transition-all cursor-pointer group"
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-foreground text-background rounded-xl flex items-center justify-center">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold">
                      {siteConfig.contact.github.split("/").pop()}
                    </div>
                  </div>
                </div>
              </Link>
