...
export function Experience({ items }: { items: any[] }) {
    ...
    return (
        <div className="mb-4 font-mono max-w-6xl mx-auto px-6 md:px-12" id="experience">
            <SectionHeader
                title="Experience"
...
export function TechStack() {
    ...
    return (
        <div className="font-mono max-w-6xl mx-auto px-6 md:px-12 mb-8">
...
export function ShelvesSection() {
    ...
    return (
        <div className="section max-w-6xl mx-auto px-6 md:px-12 mb-8">
