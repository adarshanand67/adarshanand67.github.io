                    ...
                    <div className="w-full max-w-4xl mx-auto flex flex-col gap-4 glass p-6 sm:p-8 rounded-2xl animate-fade-in relative">
                        ...
                        <div className="content text-lg leading-relaxed space-y-4 mt-6">
                            {profile.bio.paragraphs.map((paragraph: string, index: number) => (
                                <p
                                    ...
                                    dangerouslySetInnerHTML={{
                                        __html: paragraph
                                            .replace("Trellix", `<a href="https://trellix.com" target="_blank" class="text-green-700 dark:text-green-400 hover:underline font-semibold hover:text-green-600 dark:hover:text-green-300 transition-colors">Trellix</a>`)
                                            .replace("Intel Corporation", `<a href="https://intel.com" target="_blank" class="text-green-700 dark:text-green-400 hover:underline font-semibold hover:text-green-600 dark:hover:text-green-300 transition-colors">Intel Corporation</a>`),
                                    }}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-4">
                                <Link href={`https://${siteConfig.contact.linkedin}`} target="_blank" className="group relative overflow-hidden glass rounded-lg p-3 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20 hover:-translate-y-1">
                                ...
                                <div onClick={() => { navigator.clipboard.writeText(siteConfig.contact.email); }} className="group relative overflow-hidden glass rounded-lg p-3 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20 hover:-translate-y-1 cursor-pointer">
                                    <div className="flex items-center gap-3">
                                        <div className="flex-shrink-0 w-10 h-10 bg-green-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                                ...
                                <Link href={`https://${siteConfig.contact.github}`} target="_blank" className="group relative overflow-hidden glass rounded-lg p-3 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20 hover:-translate-y-1">
                                    <div className="flex items-center gap-3">
                                        <div className="flex-shrink-0 w-10 h-10 bg-green-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
