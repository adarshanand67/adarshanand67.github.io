...
export function Terminal() {
    const {
        ...
        passwordMode, isExpanded, setIsExpanded,
        position, isDragging
    } = useStore();
                ...
                <section className="font-mono">
                    ...
                    <div className={`transition-all duration-500 ease-in-out ${isExpanded ? 'opacity-100 max-h-[1000px]' : 'opacity-0 max-h-0 overflow-hidden'}`}>
                        ...
                        >
                            ...
                            <TerminalContent
                                lines={lines} isIntroDone={isIntroDone} passwordMode={passwordMode}
                                input={input} containerRef={containerRef} inputRef={inputRef}
                                handleKeyDown={handleKeyDown} onChange={(e) => setInput(e.target.value)}
