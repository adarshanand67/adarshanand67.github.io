...
const MUSIC_CDN = "https://github.com/adarshanand67/adarshanand67.github.io/releases/download/music-assets";
...
export const introLines = ["$ neofetch", ...systemStats, ""] as const;
